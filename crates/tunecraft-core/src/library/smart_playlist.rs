...
impl Rule {
    ...
    fn extract_field(&self, track: &Track) -> FieldValue {
        match self.field.as_str() {
            ...
            "play_count" => FieldValue::Integer(track.play_count.unwrap_or(0) as i64),
            ...
            "bpm" => FieldValue::Float(track.bpm.unwrap_or(0.0) as f64),
...
fn extract_sort_value(track: &Track, field: &str) -> SortValue {
    match field {
        ...
        "bpm" => SortValue::Float(track.bpm.unwrap_or(0.0) as f64),
