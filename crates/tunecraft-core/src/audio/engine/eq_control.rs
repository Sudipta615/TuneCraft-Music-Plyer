...
impl AudioEngine {
    ...
    pub fn set_eq_band_gain(&self, band_index: usize, gain: f64) {
        {
            ...
            if band_index < eq.bands.len() {
                eq.bands[band_index].gain = gain.clamp(-24.0, 24.0);
            }
        }
        self.dsp_arc()
            .lock()
            .unwrap_or_else(|e| e.into_inner())
            .set_band_gain(band_index, gain as f32);
    }
    ...
    pub fn set_bass_freq_hz(&self, freq_hz: f64) {
        ...
        self.dsp_arc()
            .lock()
            .unwrap_or_else(|e| e.into_inner())
            .set_bass_freq(f as f32);
    }
    pub fn bass_freq_hz(&self) -> f64 {
        self.eq_state
            .lock()
            .unwrap_or_else(|e| e.into_inner())
            .bass_freq_hz
    ...
    pub fn set_treble_freq_hz(&self, freq_hz: f64) {
        ...
        self.dsp_arc()
            .lock()
            .unwrap_or_else(|e| e.into_inner())
            .set_treble_freq(f as f32);
    }
    pub fn treble_freq_hz(&self) -> f64 {
        self.eq_state
            .lock()
            .unwrap_or_else(|e| e.into_inner())
            .treble_freq_hz
